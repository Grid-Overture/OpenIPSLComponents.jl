...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen3_bus_5300.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 5300 of the Nordic 44 base case: GENSAL + HYGOV + SCRX + STAB2A, rated
...
@component function Gen3_bus_5300(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
    ...
    gENSAL = redeclared(mods, :gENSAL, GENSAL)(; name = :gENSAL, modified(mods, :gENSAL, (; Tppd0 = 0.05,
        Tppq0 = 0.15, D = 0.0, Tpd0 = 6.4, H = 3.5, Xd = 1.14, Xq = 0.84, Xpd = 0.34, Xppd = 0.26, Xppq = 0.26,
        Xl = 0.2, M_b = 1200*1e6, S10 = 0.1, S12 = 0.3, R_a = 0.0, V_b = V_b, v_0 = v_0, angle_0 = angle_0,
