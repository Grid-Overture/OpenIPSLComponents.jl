...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen5_bus_5100.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 5100 of the Nordic 44 base case: GENSAL + HYGOV + SEXS, rated
# M_b = 1200 MVA on the system's S_b = 1000 MVA, with `cte(k = 0)` on VOTHSG, VUEL and VOEL of the SEXS.
...
@component function Gen5_bus_5100(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
        v_0 = 1, angle_0 = 0, mods = (;))
    @named base = pfComponent(; S_b, V_b, fn, P_0, Q_0, v_0, angle_0)
    gENSAL = redeclared(mods, :gENSAL, GENSAL)(; name = :gENSAL, modified(mods, :gENSAL, (; Tpd0 = 4.9629,
        Tppd0 = 0.05, Tppq0 = 0.15, H = 3.9871, D = 0.0, Xd = 1.1332, Xq = 0.68315, Xpd = 0.24302, Xppd = 0.15135,
        Xppq = 0.15135, Xl = 0.13405, M_b = 1200*1e6, S10 = 0.1, S12 = 0.3, R_a = 0.0, V_b = V_b, v_0 = v_0,
