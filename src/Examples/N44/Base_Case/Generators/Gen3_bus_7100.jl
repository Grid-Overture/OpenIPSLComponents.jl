...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen3_bus_7100.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 7100 of the Nordic 44 base case: GENSAL + HYGOV + SCRX + STAB2A, rated
# M_b = 1000 MVA on the system's S_b = 1000 MVA, with `cte(k = 0)` on VUEL and VOEL of the SCRX.
...
@component function Gen3_bus_7100(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
        v_0 = 1, angle_0 = 0, mods = (;))
    @named base = pfComponent(; S_b, V_b, fn, P_0, Q_0, v_0, angle_0)
    gENSAL = redeclared(mods, :gENSAL, GENSAL)(; name = :gENSAL, modified(mods, :gENSAL, (; D = 0.0, Tpd0 = 5.0,
        Tppd0 = 0.06, Tppq0 = 0.1, H = 3.2, Xd = 0.75, Xq = 0.5, Xpd = 0.25, Xppd = 0.15385, Xppq = 0.15385,
        Xl = 0.11538, M_b = 1000*1e6, S10 = 0.10239, S12 = 0.2742, R_a = 0.0, V_b = V_b, v_0 = v_0,
