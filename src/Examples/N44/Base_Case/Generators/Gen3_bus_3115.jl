...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen3_bus_3115.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 3115 of the Nordic 44 base case: GENSAL + HYGOV + SCRX + STAB2A, rated
# M_b = 1100 MVA on the system's S_b = 1000 MVA, with `cte(k = 0)` on VUEL and VOEL of the SCRX.
...
@component function Gen3_bus_3115(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
        v_0 = 1, angle_0 = 0, mods = (;))
    @named base = pfComponent(; S_b, V_b, fn, P_0, Q_0, v_0, angle_0)
    gENSAL = redeclared(mods, :gENSAL, GENSAL)(; name = :gENSAL, modified(mods, :gENSAL, (; D = 0.0, Tpd0 = 7.57,
        Tppd0 = 0.045, Tppq0 = 0.1, H = 4.741, Xd = 0.946, Xq = 0.565, Xpd = 0.29, Xppd = 0.23, Xppq = 0.23,
        Xl = 0.11077, M_b = 1100*1e6, S10 = 0.10239, S12 = 0.2742, R_a = 0.0, V_b = V_b, v_0 = v_0,
    ...
    hYGOV = redeclared(mods, :hYGOV, HYGOV)(; name = :hYGOV, modified(mods, :hYGOV, (; R = 0.06, r = 0.4, VELM = 0.1,
        T_r = 5.0, T_f = 0.05, T_g = 0.2, G_MAX = 1.0, G_MIN = 0.0, T_w = 1.0, A_t = 1.0577, D_turb = 0.5,
        q_NL = 0.1))...)
    ...
    sTAB2A = redeclared(mods, :sTAB2A, STAB2A)(; name = :sTAB2A, modified(mods, :sTAB2A, (; H_LIM = 0.04, K_2 = 1.0,
        T_2 = 4.5, K_3 = 0.87, T_3 = 2.0, K_4 = 0.087, K_5 = 1.0, T_5 = 0.01))...)
