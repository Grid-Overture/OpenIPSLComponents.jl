...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen2_bus_3249.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 3249 of the Nordic 44 base case: GENSAL + HYGOV + SCRX, rated
# M_b = 1357 MVA on the system's S_b = 1000 MVA, with `cte(k = 0)` on VOTHSG, VUEL and VOEL of the SCRX.
...
@component function Gen2_bus_3249(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
        v_0 = 1, angle_0 = 0, mods = (;))
    @named base = pfComponent(; S_b, V_b, fn, P_0, Q_0, v_0, angle_0)
    gENSAL = redeclared(mods, :gENSAL, GENSAL)(; name = :gENSAL, modified(mods, :gENSAL, (; Tppd0 = 0.06,
        Tppq0 = 0.1, D = 0.0, Tpd0 = 10.13, H = 4.543, Xd = 1.036, Xq = 0.63, Xpd = 0.28, Xppd = 0.21, Xppq = 0.21,
        Xl = 0.11538, M_b = 1357*1e6, S10 = 0.10239, S12 = 0.2742, R_a = 0.0, V_b = V_b, v_0 = v_0,
    ...
    eqs = Equation[
        ...
        sCRX.VOTHSG ~ cte.y,   # connect(sCRX.VOTHSG, cte.y)
        ...
        sCRX.ECOMP ~ gENSAL.ETERM,   # connect(sCRX.ECOMP, gENSAL.ETERM)
    ]
