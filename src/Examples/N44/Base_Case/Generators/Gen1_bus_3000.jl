...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen1_bus_3000.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 3000 of the Nordic 44 base case: GENROU + IEESGO + IEEET2 + STAB2A, rated
# M_b = 1300 MVA on the system's S_b = 1000 MVA, with `cte(k = 0)` on VUEL and VOEL of the IEEET2.
...
# Quirk of the .mo dropped: `connect(pwPin, pwPin)`, the pin connected to itself -- a no-op
# in Modelica, and not an MTK equation.
# Omitted: graphical annotations, displayPF.

@component function Gen1_bus_3000(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
        v_0 = 1, angle_0 = 0, mods = (;))
    @named base = pfComponent(; S_b, V_b, fn, P_0, Q_0, v_0, angle_0)
    gENROU = redeclared(mods, :gENROU, GENROU)(; name = :gENROU, modified(mods, :gENROU, (; Tpd0 = 5.0, Tppd0 = 0.05,
        Tpq0 = 1.0, Tppq0 = 0.05, H = 5.97, D = 0.0, Xd = 2.22, Xq = 2.13, Xpd = 0.36, Xpq = 0.468, Xppd = 0.225,
        Xppq = 0.225, Xl = 0.1688, M_b = 1300*1e6, S10 = 0.1089, S12 = 0.378, R_a = 0.0, V_b = V_b, v_0 = v_0,
    ...
    iEEET2 = redeclared(mods, :iEEET2, IEEET2)(; name = :iEEET2, modified(mods, :iEEET2, (; T_R = 0.0, K_A = 729.0,
    ...
    sTAB2A = redeclared(mods, :sTAB2A, STAB2A)(; name = :sTAB2A, modified(mods, :sTAB2A, (; H_LIM = 0.03, K_2 = 1.0,
        T_2 = 2.0, K_3 = 0.0, T_3 = 2.0, K_4 = 0.55, K_5 = 1.0, T_5 = 0.01))...)
    ...
    eqs = Equation[
        ...
        iEEET2.VOEL ~ cte.y,   # connect(iEEET2.VOEL, cte.y)
