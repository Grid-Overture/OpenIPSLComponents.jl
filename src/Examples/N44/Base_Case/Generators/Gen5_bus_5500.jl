...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen5_bus_5500.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 5500 of the Nordic 44 base case: GENSAL + HYGOV + SEXS, rated
# M_b = 1450 MVA on the system's S_b = 1000 MVA, with `cte(k = 0)` on VOTHSG, VUEL and VOEL of the SEXS.
...
@component function Gen5_bus_5500(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
    ...
    gENSAL = redeclared(mods, :gENSAL, GENSAL)(; name = :gENSAL, modified(mods, :gENSAL, (; Tppd0 = 0.05,
        Tppq0 = 0.15, D = 0.0, Tpd0 = 7.198, H = 3.0, Xd = 1.2364, Xq = 0.65567, Xpd = 0.37415, Xppd = 0.22825,
        Xppq = 0.22825, Xl = 0.16194, M_b = 1450*1e6, S10 = 0.1, S12 = 0.3, R_a = 0.0, V_b = V_b, v_0 = v_0,
