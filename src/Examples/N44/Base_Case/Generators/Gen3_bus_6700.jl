...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen3_bus_6700.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 6700 of the Nordic 44 base case: GENSAL + HYGOV + SCRX + STAB2A, rated
# M_b = 1200 MVA on the system's S_b = 1000 MVA, with `cte(k = 0)` on VUEL and VOEL of the SCRX.
...
@component function Gen3_bus_6700(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
        v_0 = 1, angle_0 = 0, mods = (;))
    @named base = pfComponent(; S_b, V_b, fn, P_0, Q_0, v_0, angle_0)
    gENSAL = redeclared(mods, :gENSAL, GENSAL)(; name = :gENSAL, modified(mods, :gENSAL, (; Tpd0 = 5.24,
        Tppd0 = 0.05, Tppq0 = 0.15, H = 3.592, D = 0.0, Xd = 1.1044, Xq = 0.66186, Xpd = 0.25484, Xppd = 0.17062,
        Xppq = 0.17062, Xl = 0.14737, V_b = V_b, M_b = 1200*1e6, S10 = 0.1, S12 = 0.3, R_a = 0.0, v_0 = v_0,
