...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen4_bus_3300.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 3300 of the Nordic 44 base case: GENROU + IEESGO + SCRX + STAB2A, rated
...
@component function Gen4_bus_3300(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
        v_0 = 1, angle_0 = 0, mods = (;))
    @named base = pfComponent(; S_b, V_b, fn, P_0, Q_0, v_0, angle_0)
    gENROU = redeclared(mods, :gENROU, GENROU)(; name = :gENROU, modified(mods, :gENROU, (; Tpd0 = 10.8,
        Tppd0 = 0.05, Tpq0 = 1.0, Tppq0 = 0.05, H = 6.0, D = 0.0, Xd = 2.42, Xq = 2.0, Xpd = 0.23, Xpq = 0.4108,
        Xppd = 0.16, Xppq = 0.16, Xl = 0.1481, M_b = 1100*1e6, S10 = 0.1089, S12 = 0.378, R_a = 0.0, V_b = V_b,
