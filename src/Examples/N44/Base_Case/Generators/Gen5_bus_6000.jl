...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen5_bus_6000.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 6000 of the Nordic 44 base case: GENSAL + HYGOV + SEXS, rated
# M_b = 680 MVA on the system's S_b = 1000 MVA, with `cte(k = 0)` on VOTHSG, VUEL and VOEL of the SEXS.
...
@component function Gen5_bus_6000(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
    ...
    gENSAL = redeclared(mods, :gENSAL, GENSAL)(; name = :gENSAL, modified(mods, :gENSAL, (; Tppd0 = 0.05,
        Tppq0 = 0.15, D = 0.0, Tpd0 = 9.7, H = 3.5, Xd = 1.28, Xq = 0.94, Xpd = 0.37, Xppd = 0.28, Xppq = 0.28,
        Xl = 0.2, M_b = 680*1e6, S10 = 0.1, S12 = 0.3, R_a = 0.0, V_b = V_b, v_0 = v_0, angle_0 = angle_0, P_0 = P_0,
        Q_0 = Q_0, S_b, fn))...)
    hYGOV = redeclared(mods, :hYGOV, HYGOV)(; name = :hYGOV, modified(mods, :hYGOV, (; R = 0.06, VELM = 0.2, r = 0.3,
        T_r = 5.0, T_f = 0.05, T_g = 0.2, G_MAX = 1.0, G_MIN = 0.0, T_w = 1.0, A_t = 1.1, D_turb = 0.5,
        q_NL = 0.1))...)
    sEXS = redeclared(mods, :sEXS, SEXS)(; name = :sEXS, modified(mods, :sEXS, (; K = 20.0, T_AT_B = 1.0, T_B = 0.1,
        T_E = 0.1, E_MIN = -4.0, E_MAX = 4.0))...)
