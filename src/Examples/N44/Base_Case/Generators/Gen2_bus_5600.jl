...
#
# OpenIPSL 3.1.0 - Examples/N44/Base_Case/Generators/Gen2_bus_5600.mo
# (extends Electrical/Essentials/pfComponent.mo), drafted automatically
# (2026-09-21, --kind base); reviewed by hand.
# Generation unit of bus 5600 of the Nordic 44 base case: GENSAL + HYGOV + SCRX, rated
# M_b = 1650 MVA on the system's S_b = 1000 MVA, with `cte(k = 0)` on VOTHSG, VUEL and VOEL of the SCRX.
...
@component function Gen2_bus_5600(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0,
        v_0 = 1, angle_0 = 0, mods = (;))
    @named base = pfComponent(; S_b, V_b, fn, P_0, Q_0, v_0, angle_0)
    gENSAL = redeclared(mods, :gENSAL, GENSAL)(; name = :gENSAL, modified(mods, :gENSAL, (; D = 0.0, Tpd0 = 7.85,
        Tppd0 = 0.05, Tppq0 = 0.15, H = 3.5, Xd = 1.0, Xq = 0.51325, Xpd = 0.38, Xppd = 0.28, Xppq = 0.28, Xl = 0.21,
        M_b = 1650*1e6, S10 = 0.1, S12 = 0.3, R_a = 0.0, V_b = V_b, v_0 = v_0, angle_0 = angle_0, P_0 = P_0,
        Q_0 = Q_0, S_b, fn))...)
    hYGOV = redeclared(mods, :hYGOV, HYGOV)(; name = :hYGOV, modified(mods, :hYGOV, (; R = 0.06, r = 0.3, VELM = 0.2,
