...
#
# OpenIPSL 3.1.0 - Examples/TwoAreas/Two_Areas_PSSE_AVR.mo, drafted automatically (2026-09-14);
# reviewed by hand. extends: none (Modelica.Icons.Example is graphical). Omitted: graphical annotations, displayPF.
# The same 11-bus, 4-machine, 2-area system as Two_Areas_PSSE.jl (network, loads, fault, PF_results, r/x/b) with the
# Groups/PSSE/AVR units: GENROU machines with SEXS (g1, g3) and ESDC1A (g2, g4) exciters.

@component function Two_Areas_PSSE_AVR(; name, S_b = 100e6, fn = 60, PF_results = TwoAreas_PF2)
    r = 0.0001   # parameter
    x = 0.001   # parameter
    ...
    systems = @named begin
        ...
        bus10 = Bus(; S_b, fn)
        bus11 = Bus(; S_b, fn)
        g1 = TwoAreas_AVR_G1(; v_0 = V.V1, angle_0 = V.A1, P_0 = M.P1_1, Q_0 = M.Q1_1, S_b, fn)
        g2 = TwoAreas_AVR_G2(; v_0 = V.V2, angle_0 = V.A2, P_0 = M.P2_1, Q_0 = M.Q2_1, S_b, fn)
        g3 = TwoAreas_AVR_G3(; v_0 = V.V3, angle_0 = V.A3, P_0 = M.P3_1, Q_0 = M.Q3_1, S_b, fn)
        g4 = TwoAreas_AVR_G4(; v_0 = V.V4, angle_0 = V.A4, P_0 = M.P4_1, Q_0 = M.Q4_1, S_b, fn)
