...
#
# OpenIPSL 3.1.0 - Examples/KundurSMIB/SMIB.mo (extends SMIB_Partial.mo), transcribed by
# the transcriber (2026-09-16); reviewed by hand. Named `KundurSMIB_SMIB` (JULIA_NAMES).
...
@component function KundurSMIB_SMIB(; name, S_b = 2220e6, fn = 60)
    @named base = KundurSMIB_Partial(; S_b, fn)
    @unpack B1 = base
    systems = @named begin
        G1 = KundurSMIB_Generator(; v_0 = 1.0, P_0 = 0.899999999997135 * S_b, Q_0 = 0.436002238696658 * S_b,
