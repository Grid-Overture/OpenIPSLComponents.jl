...
#
# Modelica Standard Library 4.0.0 - Blocks/Logical.mo, block LessThreshold
# Ports are plain variables (u, y (partialBooleanThresholdComparison)). Omitted: graphical annotations.

# Boolean output as Real 0/1 (PLAN-01). The twin of `GreaterThreshold`: the comparison is a state event in
...
@component function LessThreshold(; name, threshold = 0, rootfind = SciMLBase.LeftRootFind)
