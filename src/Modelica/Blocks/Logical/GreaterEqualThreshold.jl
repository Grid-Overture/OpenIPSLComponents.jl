...
#
# Modelica Standard Library 4.0.0 - Blocks/Logical.mo, block GreaterEqualThreshold
...
@component function GreaterEqualThreshold(; name, threshold = 0, rootfind = SciMLBase.LeftRootFind)
