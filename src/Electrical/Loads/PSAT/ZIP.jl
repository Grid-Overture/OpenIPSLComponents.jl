...
#
# OpenIPSL 3.1.0 - Electrical/Loads/PSAT/ZIP.mo (extends BaseClasses/baseLoad.mo)
# Blocks: none. Pp and Qp default to 1 - Pz - Pi and 1 - Qz - Qi as in the .mo. Omitted: graphical annotations.

@component function ZIP(; name, S_b = 100e6, V_b = 400e3, fn = 50, P_0 = 1e6, Q_0 = 0, v_0 = 1, angle_0 = 0, Sn = S_b,
        Pz = 0.33, Pi = 0.33, Pp = 1 - Pz - Pi, Qz = 0.33, Qi = 0.33, Qp = 1 - Qz - Qi)
