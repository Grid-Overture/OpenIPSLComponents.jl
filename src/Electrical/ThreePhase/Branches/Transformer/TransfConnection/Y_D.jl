...
#
# OpenIPSL 3.1.0 - Electrical/ThreePhase/Branches/Transformer/TransfConnection/Y_D.mo (function)
# The 12x12 pi matrix [A B; C D] of a Y_D three-phase transformer, argument order (X, R, tap) as in the .mo.
# Named TransfConnection_Y_D in Julia: the nine connections repeat the names of the MonoTri TransformerFcn family
...
function TransfConnection_Y_D(X, R, tap)
