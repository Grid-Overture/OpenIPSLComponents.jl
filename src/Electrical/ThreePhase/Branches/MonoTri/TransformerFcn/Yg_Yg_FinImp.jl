...
#
# OpenIPSL 3.1.0 - Electrical/ThreePhase/Branches/MonoTri/TransformerFcn/Yg_Yg_FinImp.mo (function)
# As TransformerFcn_Yg_Yg but with FINITE Norton equivalent admittances, passed as the extra 1x18 argument Y012
...
function TransformerFcn_Yg_Yg_FinImp(X, R, tap, Y012)
    ...
    Yser = [Gser, Bser, 0, 0, 0, 0, 0, 0, Gser, Bser, 0, 0, 0, 0, 0, 0, Gser, Bser]
    Yshtk = [Gshk, Bshk, 0, 0, 0, 0, 0, 0, Gshk, Bshk, 0, 0, 0, 0, 0, 0, Gshk, Bshk]
    Yshtm = [Gshm, Bshm, 0, 0, 0, 0, 0, 0, Gshm, Bshm, 0, 0, 0, 0, 0, 0, Gshm, Bshm]
    A = Yabcnrt + Yshtk
    B = Inverse(A)
    C = Inverse(Yser)
    D = B + C
