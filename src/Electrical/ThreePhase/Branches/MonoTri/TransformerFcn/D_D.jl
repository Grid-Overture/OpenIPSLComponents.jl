...
#
# OpenIPSL 3.1.0 - Electrical/ThreePhase/Branches/MonoTri/TransformerFcn/D_D.mo (function)
# The 32 coefficients [Ar, Ai, MB1r, ..., D33i] of the hybrid positive-sequence/three-phase pi model of a D_D
# transformer, argument order (X, R, tap) as in the .mo; a Vector of 32 in Julia. Norton equivalent impedances
# assumed infinite (the _FinImp variants take them finite). Named TransformerFcn_D_D in Julia: the family repeats
# the names of TransfConnection (package rule 6.5). Transcribed literally; omitted: the documentation annotation.

function TransformerFcn_D_D(X, R, tap)
