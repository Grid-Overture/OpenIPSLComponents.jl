...
#
# OpenIPSL 3.1.0 - Electrical/ThreePhase/Branches/MonoTri/TransformerFcn/Y_Y_FinImp.mo (function)
# As TransformerFcn_Y_Y but with FINITE Norton equivalent admittances, passed as the extra 1x18 argument Y012
...
function TransformerFcn_Y_Y_FinImp(X, R, tap, Y012)
