...
#
# OpenIPSL 3.1.0 - Electrical/ThreePhase/Branches/MonoTri/MonoTriFcn/NegZerFilter.mo (function)
# Negative- and zero-sequence filter of the Norton equivalent: the same product as PositiveFilter.jl with
# g0 = 1, g1 = 0, g2 = 1. Vectors of 18 as in Inverse.jl. Transcribed literally; omitted: the documentation
# annotation.

function NegZerFilter(Z)
    g0 = 1
    b0 = 0
    g1 = 0
    b1 = 0
