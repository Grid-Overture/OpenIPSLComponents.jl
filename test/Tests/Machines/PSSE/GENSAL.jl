...
#
# OpenIPSL 3.1.0 - Tests/Machines/PSSE/GENSAL.mo, transcribed automatically (2026-09-14); reviewed by hand.
# extends: OpenIPSL.Tests.BaseClasses.SMIB. Omitted: graphical annotations, displayPF.
# `GENSAL` is the machine (PLAN-02: a Test named as its model gets the suffix _Test).
@component function GENSAL_Test(; name, S_b = 100e6, fn = 50)
...
@testset "Tests.Machines.PSSE.GENSAL" begin
    oracle = include(joinpath(@__DIR__, "..", "..", "..", "oracle", "Machines.PSSE.GENSAL.jl"))
    validate_against_oracle(GENSAL_Test, oracle)
end
