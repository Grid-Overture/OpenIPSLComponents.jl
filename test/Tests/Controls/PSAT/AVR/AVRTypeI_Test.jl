...
#
# OpenIPSL 3.1.0 - Tests/Controls/PSAT/AVR/AVRTypeI_Test.mo, transcribed automatically (2026-09-16); reviewed by hand.
...
# The same network as Tests.Controls.PSAT.AVR.AVRTypeII_Test, with AVRTypeI in place of AVRTypeII.
@component function AVRTypeI_Test(; name, S_b = 100e6, fn = 50)
    systems = @named begin
...
@testset "Tests.Controls.PSAT.AVR.AVRTypeI_Test" begin
    oracle = include(joinpath(@__DIR__, "..", "..", "..", "..", "oracle", "Controls.PSAT.AVR.AVRTypeI_Test.jl"))
    validate_against_oracle(AVRTypeI_Test, oracle)
end
